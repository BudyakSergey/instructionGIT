...
2. Переходим на страницу репозитория и нажимаем кнопку **Fork**. После этого мы попадем на страницу создания нового удаленного репозитория в своей аккаунте на GitHub. Выполняем пункт **2, 3 и 4 (git pull)** из **_Раздела 12_**
3. Создаем в локальном репозитории новую ветку 
```
git branch <имя ветки>
```
и вносим нужные нам изменения.
4. Добавляем файл в котором вносили в статус для отслеживания **git add** и сохраняем наши изменения **git commit -m "_text_"** 
...
* <имя ветки> - которую вы создали в пункте 3.
